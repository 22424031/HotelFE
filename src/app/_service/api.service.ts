...
export class ApiService {
  ...
  cash(booking:Booking): Observable<ReservationStatus>{
    const headers = new HttpHeaders({
      'Content-Type': 'application/json, text/plain',
      'Access-Control-Allow-Origin': '*',
    });
    return this.http.post<ReservationStatus>(environment.BASE_URL_API + '/user/reservation/create', booking,{headers});
   }
